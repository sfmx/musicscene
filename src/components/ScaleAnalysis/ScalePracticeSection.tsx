        ...
        {scaleData.practiceExercises.map((exercise, index) => (
          <div key={index} className="bg-slate-50 dark:bg-slate-950/80 rounded-xl p-5 border border-slate-200 dark:border-slate-800">
            <div className="flex justify-between items-start mb-3">
              <div>
                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1">{exercise.name}</h3>
                <p className="text-slate-600 dark:text-slate-400 text-xs">{exercise.description}</p>
              </div>
              <div className="flex gap-2">
                <span className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-cyan-700 dark:text-cyan-300 px-2.5 py-0.5 rounded text-xs font-mono">
                  {exercise.type}
                </span>
            ...
            <div className="grid md:grid-cols-2 gap-4 text-xs">
              ...
              <div>
                {exercise.tempo && (
                  <div className="mb-3">
                    <h4 className="font-semibold text-slate-500 dark:text-slate-400 mb-1">Tempo Range:</h4>
                    <p className="text-cyan-700 dark:text-cyan-300 font-mono">{exercise.tempo}</p>
                  </div>
                )}
                
                <div className="mb-3">
                  <h4 className="font-semibold text-slate-500 dark:text-slate-400 mb-2">Focus Areas:</h4>
              ...
              {/* Instructions */}
              <div>
                <h4 className="font-semibold text-slate-500 dark:text-slate-400 mb-2">Practice Steps:</h4>
