        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
          ...
          <section id="key-techniques" className="mb-12">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-2xl font-black text-slate-900 dark:text-white">Key Techniques</h2>
            </div>
          ...
          {songData.sections && songData.sections.some(s => s.alphaTab) && (
            <section id="practice-exercises" className="mb-12">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="text-2xl font-black text-slate-900 dark:text-white">Practice Exercises</h2>
              </div>
              ...
              <div className="space-y-6">
                {songData.sections.filter(s => s.alphaTab).map((section, index) => (
                  <div key={index} className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl">
                    <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-200 dark:border-slate-800">
                      <div>
                        ...
                        {section.exerciseLabel && (
                          <p className="text-xs font-bold text-amber-600 dark:text-amber-400 mt-0.5">{section.exerciseLabel}</p>
                        )}
                      </div>
                      <span className="text-xs font-mono text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-slate-950 px-2.5 py-1 rounded-lg border border-slate-200 dark:border-slate-800">{section.timeStamp}</span>
                    </div>
          ...
          <section id="equipment-&-tone" className="mb-12">
            <div className="flex items-center gap-2 mb-6">
              <span className="text-xs font-bold uppercase tracking-widest text-purple-700 dark:text-purple-400 bg-purple-100/70 dark:bg-purple-500/10 px-3 py-1 rounded-full border border-purple-300 dark:border-purple-500/20">
                Rig & Signal Chain
              </span>
              <h2 className="text-2xl font-black text-slate-900 dark:text-white">Equipment & Tone Setup</h2>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
              {/* Guitar */}
              <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col justify-between">
                <div>
                  ...
                  <div className="space-y-3 text-xs">
                    ...
                    <div>
                      ...
                      <p className="text-slate-700 dark:text-slate-300 font-medium">{songData.equipment.guitar.pickup}</p>
                    </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 text-xs">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-1.5 font-mono text-[11px] bg-slate-50 dark:bg-slate-950 p-2.5 rounded-lg border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300">
                        <p>Gain: <span className="text-amber-600 dark:text-amber-300">{songData.equipment.amp.settings.gain}</span></p>
                        <p>Treble: <span className="text-amber-600 dark:text-amber-300">{songData.equipment.amp.settings.treble}</span></p>
                        <p>Middle: <span className="text-amber-600 dark:text-amber-300">{songData.equipment.amp.settings.middle}</span></p>
                        <p>Bass: <span className="text-amber-600 dark:text-amber-300">{songData.equipment.amp.settings.bass}</span></p>
                        <p className="col-span-2">Presence: <span className="text-amber-600 dark:text-amber-300">{songData.equipment.amp.settings.presence}</span></p>
                      </div>
                    </div>
          ...
          <section id="learning-path" className="mb-12">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-2xl font-black text-slate-900 dark:text-white">Recommended Learning Path</h2>
            </div>

            <div className="grid md:grid-cols-3 gap-6">
              {/* Beginner */}
              <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-emerald-500/40 dark:border-emerald-500/30 shadow-xl">
                <h3 className="text-base font-bold text-emerald-700 dark:text-emerald-400 mb-2">{songData.learningPath.beginner.title}</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 font-mono mb-4">⏱️ {songData.learningPath.beginner.timeEstimate}</p>
              ...
              {/* Intermediate */}
              <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-amber-500/40 dark:border-amber-500/30 shadow-xl">
                <h3 className="text-base font-bold text-amber-700 dark:text-amber-400 mb-2">{songData.learningPath.intermediate.title}</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 font-mono mb-4">⏱️ {songData.learningPath.intermediate.timeEstimate}</p>
                <ul className="text-xs text-slate-600 dark:text-slate-300 space-y-2">
              ...
              {/* Advanced */}
              <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-rose-500/40 dark:border-rose-500/30 shadow-xl">
                <h3 className="text-base font-bold text-rose-700 dark:text-rose-400 mb-2">{songData.learningPath.advanced.title}</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400 font-mono mb-4">⏱️ {songData.learningPath.advanced.timeEstimate}</p>
                <ul className="text-xs text-slate-600 dark:text-slate-300 space-y-2">
          ...
          <section id="practice-notes" className="mb-12">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-2xl font-black text-slate-900 dark:text-white">Practice Notes & Routine</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              {/* Practice Routine */}
              <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-blue-500/40 dark:border-blue-500/30 shadow-xl">
                <h3 className="text-base font-bold text-blue-700 dark:text-blue-400 mb-4 flex items-center gap-2">
              ...
              {songData.practiceNotes.metronomeWork && songData.practiceNotes.metronomeWork.length > 0 && (
                <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-purple-500/40 dark:border-purple-500/30 shadow-xl">
          ...
          <section id="related-songs" className="mb-12">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className="text-2xl font-black text-slate-900 dark:text-white">Related Songs</h2>
            </div>
            
            {/* Artist Songs */}
            {songData.relatedSongs.acdc && songData.relatedSongs.acdc.length > 0 && (
              <div className="mb-8">
                <h3 className="text-base font-bold text-slate-800 dark:text-slate-300 mb-4">More from this Artist</h3>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {songData.relatedSongs.acdc.map((song, index) => (
                    <div key={index} className="bg-white dark:bg-slate-900/90 rounded-2xl p-5 border border-slate-200 dark:border-slate-800 hover:border-amber-500/50 dark:hover:border-slate-700 transition-all flex flex-col justify-between group shadow-md">
                      <div>
                        <h4 className="font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-300 transition-colors mb-2">{song.title}</h4>
                        <p className="text-xs text-slate-600 dark:text-slate-400 mb-3">{song.similarity}</p>
                      </div>
                      {song.link && (
                        <Link href={song.link} className="text-amber-600 dark:text-amber-400 group-hover:text-amber-700 dark:group-hover:text-amber-300 font-bold text-xs inline-flex items-center gap-1 hover:underline">
            ...
            {songData.relatedSongs.similarTechniques && songData.relatedSongs.similarTechniques.length > 0 && (
              <div>
                <h3 className="text-base font-bold text-slate-800 dark:text-slate-300 mb-4">Songs With Similar Techniques</h3>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {songData.relatedSongs.similarTechniques.map((song, index) => (
                    <div key={index} className="bg-white dark:bg-slate-900/90 rounded-2xl p-5 border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 dark:hover:border-slate-700 transition-all flex flex-col justify-between group shadow-md">
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          <h4 className="font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-300 transition-colors">{song.title}</h4>
                          {song.technique && (
                            <span className="text-[10px] font-bold bg-blue-50 dark:bg-slate-950 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-slate-800 px-2 py-0.5 rounded-full">
                              {song.technique}
                            </span>
                          )}
                        </div>
                        <p className="text-xs text-slate-500 mb-2">by {song.artist}</p>
                        <p className="text-xs text-slate-600 dark:text-slate-400">{song.similarity}</p>
                      </div>
                    </div>
                  ))}
                </div>
