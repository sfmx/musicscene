...
export default function ChordNavigationSection({ journeySection, colorScheme }: ChordNavigationSectionProps) {
  return (
    <div className="bg-gradient-to-br from-slate-100 via-white to-slate-100 dark:from-slate-900 dark:via-slate-900/95 dark:to-slate-950 rounded-2xl p-8 border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-xl mb-12">
      <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3 text-center">{journeySection.title}</h2>
        ...
        {journeySection.links.map((link, i) => (
          ...
          >
            <div className="text-center">
              <div className="w-12 h-12 bg-cyan-50 dark:bg-cyan-950/50 border border-cyan-200 dark:border-cyan-500/30 group-hover:border-cyan-400/60 rounded-full flex items-center justify-center mx-auto mb-4 transition-colors">
