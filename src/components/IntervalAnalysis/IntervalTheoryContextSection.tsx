  ...
  return (
    <div className="bg-white dark:bg-slate-900/90 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-xl p-6 sm:p-8 mb-12">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          <h3 className="text-base font-bold text-cyan-700 dark:text-cyan-300 mb-4">Harmonic Function</h3>
        ...
        <div>
          <h3 className="text-base font-bold text-amber-700 dark:text-amber-300 mb-4">Historical Development</h3>
          <div className="space-y-3">
