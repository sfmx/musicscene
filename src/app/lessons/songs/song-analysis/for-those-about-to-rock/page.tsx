  ...
  return (
    <Layout>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• <Link href="/lessons/songs/song-analysis/thunderstruck" className="text-cyan-600 hover:text-cyan-800">"Thunderstruck"</Link> - Similar energy, different techniques</li>
                <li>• <Link href="/lessons/songs/song-analysis/back-in-black" className="text-cyan-600 hover:text-cyan-800">"Back in Black"</Link> - Classic I-IV-V progression</li>
                <li>• <Link href="/lessons/songs/song-analysis/highway-to-hell" className="text-cyan-600 hover:text-cyan-800">"Highway to Hell"</Link> - Similar chord structure</li>
        ...
        {/* Final Section - Explore More */}
        <section className="text-center py-12 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl border border-cyan-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Explore More Song Analysis</h2>
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            Continue your journey with our comprehensive song breakdowns that combine playing techniques with music theory understanding.
          </p>
          <Link 
