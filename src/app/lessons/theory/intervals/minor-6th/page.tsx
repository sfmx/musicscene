            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-5 border border-purple-200">
                <div className="text-center mb-4">
                  ...
                  <div className="bg-white rounded-lg p-3 mb-3">
                    <AlphaTexRenderer 
                      alphaTex="3.5.4 6.4.4" 
                      title="C to Ab Minor 6th" 
                      className="scale-75"
                    />
                  </div>
              ...
              <div className="bg-gradient-to-br from-violet-50 to-violet-100 rounded-lg p-5 border border-violet-200">
                <div className="text-center mb-4">
                  ...
                  <div className="bg-white rounded-lg p-3 mb-3">
                    <AlphaTexRenderer 
                      alphaTex="1.6.4 4.5.4" 
                      title="F to Db Minor 6th" 
                      className="scale-75"
                    />
                  </div>
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg p-5 border border-indigo-200">
                <div className="text-center mb-4">
                  ...
                  <div className="bg-white rounded-lg p-3 mb-3">
                    <AlphaTexRenderer 
                      alphaTex="0.5.4 3.4.4" 
                      title="A to F Minor 6th" 
                      className="scale-75"
                    />
                  </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6 border border-purple-200">
                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <AlphaTexRenderer 
                      alphaTex="(0.5 3.4 2.4).1 | (1.6 5.5 3.2).1" 
                      title="Am to F Progression" 
                      className="scale-75"
                    />
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg p-6 border border-indigo-200">
                ...
                <div className="space-y-4">
                  <div className="bg-white rounded-lg p-4">
                    ...
                    <AlphaTexRenderer 
                      alphaTex="3.5.2 5.5.2 | 1.4.2 3.3.2" 
                      title="Voice Leading with 6ths" 
                      className="scale-75"
                    />
