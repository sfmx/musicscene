...
export default function MixolydianScalePage() {
  return (
    <Layout>
      <Header
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-gray-50 to-orange-50 rounded-xl p-8 border border-gray-200 mb-12">
          ...
          <p className="text-gray-600 mb-8 text-center max-w-2xl mx-auto">
            Now that you understand mixolydian mode, explore other modes and scales to complete your modal knowledge.
          </p>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link href="/lessons/theory/scales/blues" className="group bg-white rounded-lg p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Combine mixolydian with the essential blues scale.
                </p>
