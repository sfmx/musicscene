      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-gray-50 to-teal-50 rounded-xl p-8 border border-gray-200 mb-12">
          ...
          <p className="text-gray-600 mb-8 text-center max-w-2xl mx-auto">
            Now that you understand dorian mode, explore other modes and scales to expand your musical palette.
          </p>
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/lessons/theory/scales/minor" className="group bg-white rounded-lg p-6 border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Compare with the traditional minor scale and its darker sound.
                </p>
            ...
            <Link href="/lessons/theory/scales/modes" className="group bg-white rounded-lg p-6 border border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all duration-300">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Other Modes</h3>
                <p className="text-sm text-gray-600 mb-4">
            ...
            <Link href="/lessons/theory/scales/minor-pentatonic" className="group bg-white rounded-lg p-6 border border-gray-200 hover:border-green-300 hover:shadow-lg transition-all duration-300">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Return to the essential minor pentatonic scale.
                </p>
