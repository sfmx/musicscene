    ...
    <Layout>
      <div className="bg-slate-50 dark:bg-slate-950 min-h-screen text-slate-900 dark:text-slate-100 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-indigo-950/50 border border-blue-100 dark:border-slate-800 p-8 mb-14">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Our Commitment</h2>
          ...
          <div className="grid gap-10 md:grid-cols-2 mb-14">
            ...
            <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-800">
              <div className="flex items-center gap-3 mb-4">
                <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-amber-100 dark:bg-amber-950/60 text-amber-600 dark:text-amber-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">FTC Disclosure</h2>
              </div>
            ...
            <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-800">
              <div className="flex items-center gap-3 mb-4">
                <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-orange-100 dark:bg-orange-950/60 text-orange-600 dark:text-orange-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                  </svg>
                </span>
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">Amazon Associates</h2>
              </div>
          ...
          <section className="mb-14">
            <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-6">Where Affiliate Links Appear</h2>
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="flex gap-4 bg-white dark:bg-slate-900/90 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
                <span className="shrink-0 flex h-9 w-9 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm5 6a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V8z" clipRule="evenodd" />
                  </svg>
                </span>
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-white mb-1">Gear Lesson Pages</h3>
              ...
              <div className="flex gap-4 bg-white dark:bg-slate-900/90 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
                <span className="shrink-0 flex h-9 w-9 items-center justify-center rounded-lg bg-violet-100 dark:bg-violet-950/60 text-violet-600 dark:text-violet-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M18 3a1 1 0 00-1.196-.98l-10 2A1 1 0 006 5v9.114A4.369 4.369 0 005 14c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3-2V7.82l8-1.6v5.894A4.37 4.37 0 0015 12c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3-2V3z" />
                  </svg>
                </span>
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-white mb-1">Song Analysis Pages</h3>
                  <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
          ...
          <section className="rounded-2xl bg-white dark:bg-slate-900/90 p-8 shadow-sm border border-slate-200 dark:border-slate-800 mb-14">
            <div className="flex items-center gap-3 mb-6">
              <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-green-100 dark:bg-green-950/60 text-green-600 dark:text-green-400">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
              </span>
              <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white">Editorial Independence</h2>
            </div>
            ...
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">Our gear recommendations are based on:</p>
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-800">
              <div className="flex items-center gap-3 mb-4">
                <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-sky-100 dark:bg-sky-950/60 text-sky-600 dark:text-sky-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clipRule="evenodd" />
                  </svg>
                </span>
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">Other Revenue</h2>
              </div>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-800">
              <div className="flex items-center gap-3 mb-4">
                <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-rose-100 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
