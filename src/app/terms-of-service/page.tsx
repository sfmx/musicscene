  ...
  return (
    <Layout>
      <div className="bg-slate-50 dark:bg-slate-950 min-h-screen pb-16 text-slate-900 dark:text-slate-100 transition-colors">
        ...
        <Header
          title="Terms of Service"
          subtitle="The rules and guidelines for using MusicScene's educational resources."
        />
          ...
          <div className="bg-white dark:bg-slate-900/90 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-8 md:p-12">
            <div className="prose prose-lg prose-blue dark:prose-invert max-w-none text-slate-600 dark:text-slate-300">
              ...
              <p className="lead text-xl text-slate-900 dark:text-white font-medium">
                ...
                <strong className="text-slate-900 dark:text-white">musicscene.com.au</strong> (the &ldquo;Site&rdquo;), you agree to be bound by these
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">1. Use of the Site</h2>
              <p>
              ...
              <p className="font-medium text-slate-900 dark:text-white mt-6 mb-2">You agree not to:</p>
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">2. Intellectual Property & Fair Dealing</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">3. Educational Disclaimer</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">4. Affiliate Links & Advertising</h2>
              <p>
                ...
                Our participation in the Amazon Associates program helps keep our core educational content free. Review our <a href="/affiliate-disclosure" className="text-blue-600 dark:text-blue-400 hover:underline">Affiliate Disclosure</a> for full details.
              </p>
              <p>
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">5. User Submissions</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">7. Disclaimer of Warranties</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">8. Governing Law</h2>
              <p>
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-10 mb-4">9. Contact Information</h2>
              <p>
                If you have questions about these Terms of Service, please reach out to us via our{' '}
                <a href="/contact" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium underline underline-offset-4">Contact page</a>.
              </p>
            </div>
          </div>
        </div>
