...
// Re-export shared utility functions from centralized @/lib/utils
export { getDifficultyColor, getDifficultyBarColor, removeConsecutiveDuplicates } from '@/lib/utils';
